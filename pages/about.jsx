...
const About = () => {
  ...
  const data = [
    ...
    { nombre : 'Juan Morales | Copywriter', descripcion : 'Perlita fue la puerta que inició el camino de aprendizaje al mundo de los bots. Los errores han sido los mejores maestros, los buenos resultados han sido la mejor recompensa.', img : '/img/juan.jpeg'},
